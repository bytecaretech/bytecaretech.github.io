<section>
    <div class="mx-auto max-w-4xl px-4 py-12">
        <h1 class="mb-4 text-3xl font-bold">Datenschutzerklärung</h1>
        <h2 class="mb-2 text-xl font-semibold">1. Datenschutz auf einen Blick</h2>
        <h3 class="mb-2 text-lg font-semibold">Allgemeine Hinweise</h3>
        <p class="text-md">
        ...
        <h3 class="mb-2 mt-2 text-lg font-semibold">Datenerfassung auf dieser Website</h3>
        ...
        <h4 class="mb-2 mt-2">Wie erfassen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 class="mb-2 mt-2">Wof&uuml;r nutzen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 class="mb-2 mt-2">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
        <p>
        ...
        <h2 class="mb-2 mt-2 text-xl font-semibold">2. Hosting</h2>
        <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
        <h3 class="mb-2 mt-2 text-lg font-semibold">Externes Hosting</h3>
        <p>
        ...
        <p>
            ...
            Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die
            Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im
            Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TDDDG umfasst.
        ...
        <h2 class="mb-2 mt-2 text-xl font-semibold">
            3. Allgemeine Hinweise und Pflicht&shy;informationen
        </h2>
        <h3 class="mt-2 text-lg font-semibold">Datenschutz</h3>
        <p>
        ...
        <h3 class="mt-2 text-lg font-semibold">Hinweis zur verantwortlichen Stelle</h3>
        <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>
        <p class="mb-2 mt-2">
            byteCare UG (haftungsbeschränkt)<br />
            Am Hangeweiher 3<br />
            52074 Aachen
        </p>
        <p class="mb-2">
        ...
        <h3 class="mb-2 mt-2 text-lg font-semibold">Speicherdauer</h3>
        <p>
        ...
        <h3 class="mb-2 mt-2 text-lg font-semibold">
        ...
        <h3 class="mb-2 mt-2 text-lg font-semibold">Empf&auml;nger von personenbezogenen Daten</h3>
        <p>
        ...
        <h3 class="mt-2 text-lg font-semibold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
        <p>
        ...
        <h3 class="mb-2 mt-2 text-lg font-semibold">Auskunft, Berichtigung und L&ouml;schung</h3>
        <p>
        ...
        <p class="mt-4">Quelle: <a href="https://www.e-recht24.de">e-recht24.de</a></p>
    </div>
</section>
